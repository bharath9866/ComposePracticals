...
fun TimePickerExamples() {
    ...
    var showAdvancedExample by remember { mutableStateOf(true) }
        ...
        if (showDial) {
            TimePicker(
                ...
                colors =  TimePickerDefaults.colors(
                    clockDialColor = Color(0xFFFFFBF0), // Very light cream
                    selectorColor = Color(0xFFE53935), // Slightly darker red
                    containerColor = Color(0xFFF8F5E4), // Warm light background
                    ...
                    timeSelectorSelectedContainerColor = Color(0xFFFFC107), // Amber yellow
    ...
    Dialog(
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = "NOTE: PREVIOUS ACTION WILL BE OVERRIDDEN IF ANY",
                ...
                Row(
                    ...
                    TextButton(onClick = onConfirm) { Text("Set Timer") }
                }
            }
        }
    }
