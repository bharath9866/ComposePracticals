...
fun TimeGraph(
    ...
    Layout(
        ...
        val dayLabelPlaceables = dayLabelMeasurables.map { measurable: Measurable ->
        ...
        val barPlaceables = barMeasureables.map { measurable: Measurable ->
        ...
        val totalWidth = dayLabelPlaceables.maxOf { it.width } + hoursHeaderPlaceable.width
